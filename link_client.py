...
def ground_mention(mention, source='dbr', nbest=10):
    """
    ...
    url = "http://127.0.0.1:5000/linking/get_best?source={0}&{1}".format(
        source, mention)
...
if __name__ == '__main__':
    ...
    results = ground_mention(args.mention, args.source)
